...
module.exports = {
	...
	handler: args => {
		if (args.game) {
			fetch(url`https://www.speedrun.com/api/v1/games?name=${args.game}&max=1`, {
				json: true,
			}, args, {
				...
				fetch(url`https://www.speedrun.com/api/v1/games/${game.id}/records?miscellaneous=no&scope=full-game&top=1`, {
					json: true,
				}, args, {
