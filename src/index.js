...
const eventMessageFactory = require("./utils/event-message-factory.js");
handler.onUserJoined = eventMessageFactory("join");
handler.onUserLeft = eventMessageFactory("leave");
